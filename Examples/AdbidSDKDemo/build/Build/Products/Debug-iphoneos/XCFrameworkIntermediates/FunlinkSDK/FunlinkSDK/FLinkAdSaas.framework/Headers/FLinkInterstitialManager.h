...
@protocol FLinkInterstitialDelegate <NSObject>
...
@interface FLinkInterstitialManager : FLinkBaseAdManager

/// 广告回调的代理
@property(nonatomic, weak) id<FLinkInterstitialDelegate> delegate;

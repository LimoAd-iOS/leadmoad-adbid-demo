...
@interface FLinkInterstitialADConfig : NSObject
...
@interface UIViewController (FLinkInterstitialAD)

- (void)flink_showInterstitialADWithConfig:(void(^)(FLinkInterstitialADConfig *config))configBlock completion:(void(^)(FLinkADResultInfo *result))resultBlock;

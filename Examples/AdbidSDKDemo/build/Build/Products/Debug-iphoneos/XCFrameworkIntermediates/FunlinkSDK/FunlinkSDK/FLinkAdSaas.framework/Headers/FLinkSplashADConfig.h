...
@interface FLinkSplashADConfig : NSObject
...
@interface UIWindow (FLinkSplashAD)

- (void)flink_showSplashADWithConfig:(void(^)(FLinkSplashADConfig *config))configBlock completion:(void(^)(FLinkADResultInfo *result))resultBlock;

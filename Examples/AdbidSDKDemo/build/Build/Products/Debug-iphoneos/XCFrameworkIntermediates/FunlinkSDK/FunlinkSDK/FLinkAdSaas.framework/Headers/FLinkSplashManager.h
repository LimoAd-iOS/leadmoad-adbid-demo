...
@protocol FLinkSplashDelegate <NSObject>
...
@interface FLinkSplashManager : FLinkBaseAdManager

/// 广告回调的代理
@property(nonatomic, weak) id<FLinkSplashDelegate> delegate;

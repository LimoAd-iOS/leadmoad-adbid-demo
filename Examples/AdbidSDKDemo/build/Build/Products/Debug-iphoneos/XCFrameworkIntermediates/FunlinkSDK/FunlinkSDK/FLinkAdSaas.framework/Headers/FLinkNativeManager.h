...
@protocol FLinkNativeDelegate <NSObject>
...
/// !!!: FLinkNativeManager 为 FLinkFeedManager 和 FLinkTemplateManager 和 FLinkDrawVideoManager 的聚合使用
///
/// 原生混合接入类
@interface FLinkNativeManager : FLinkBaseAdManager

/**
 * 广告回调的代理
 */
@property(nonatomic, weak) id<FLinkNativeDelegate> delegate;
...
/**
 ...
 @param views 可点击的视图
 */
- (void)registerAdViewForBindImage:(UIImageView *)view adData:(FLinkFeedAdData *)adData clickableViews:(NSArray *)views DEPRECATED_MSG_ATTRIBUTE("已弃用，使用 registerAdForView:adData: 替代");
 ...
 * 针对部分联盟广告主有效
 */
@property (nonatomic, assign) FLinkTemplateExpressNativeTheme theme;
